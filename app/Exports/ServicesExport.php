    ...
    public static function afterSheet(AfterSheet $event)
{
    ...
    $event->sheet->setCellValue('C2', 'Số lượng bán ra');
    $event->sheet->setCellValue('D2', 'Tổng thu');
    ...
    $event->sheet->getDelegate()->getStyle('A1:D' . $event->sheet->getDelegate()->getHighestRow())->applyFromArray([
        'borders' => [
            'allBorders' => [
                'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            ],
    ...
    $event->sheet->getDelegate()->getStyle('C3:D' . $lastRow)->getNumberFormat()
