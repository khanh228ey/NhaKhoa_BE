...
class AppointmentExport implements FromCollection , WithHeadings, WithEvents
{
        ...
        public static function afterSheet(AfterSheet $event){
            ...
            $event->sheet->setCellValue('A1', 'BẢNG THỐNG KÊ LịCH HẸN');
            ...
            $event->sheet->setCellValue('A2', 'Mã lịch hẹn');
            $event->sheet->setCellValue('B2', 'Tên khách hàng');
            $event->sheet->setCellValue('C2', 'Ngày đặt lịch');
            $event->sheet->setCellValue('D2', 'Thời gian');
            $event->sheet->setCellValue('E2', 'Trạng thái');
